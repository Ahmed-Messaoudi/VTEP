export const bodyOceanSimilarities = [
  ...
  export const quizofbodyOceanSimilarities =[
    {
        "title": "bodyOceanSimilarities ",
        "questions": [
          {
            "id": 1,
            "title": "Question 1",
            "description": " Le cœur pompe le sang dans le corps, tout comme les courants océaniques déplacent l'eau, les nutriments et la chaleur autour du globe.?",
            "options": [
          ...
          },
          {
            "id": 2,
            "title": "Question 2",
            "description": "Les poumons facilitent l'échange d'oxygène et de dioxyde de carbone, tandis que les récifs coralliens produisent tout l'oxygène que nous respirons?",
            "options": [
          ...
          },
          {
            "id": 3,
            "title": "Question 3",
            "description": "Le sang est chimiquement similaire à l'eau de mer, car les deux contiennent du sodium, du chlorure, du potassium et du magnésium?",
            "options": [
              { "text": "FAUX", "isCorrect": false },
      ...
      },
      {
        "id": 4,
        "title": "Question 4",
        "description": "La peau agit comme une barrière, tout comme la surface de l'océan protège les écosystèmes marins en dessous?",
        "options": [
          { "text": "VRAI", "isCorrect": true },
      ...
      },
      {
        "id": 5,
        "title": "Question 5",
        "description": "Le cerveau et les profondeurs océaniques sont vastes et essentiels à la vie, bien que le fonctionnement du cerveau soit bien plus compris que celui de l'océan?",
        "options": [
          { "text": "VRAI", "isCorrect": false },
          { "text": "FAUX", "isCorrect": true }
        ]
      },
      {
        "id": 1,
        "title": "Question 6",
        "description": "L'estomac décompose la nourriture pour produire de l'énergie, tout comme les évents hydrothermaux transforment les minéraux en énergie pour des écosystèmes uniques?",
        "options": [
          { "text": "VRAI", "isCorrect": true },
          { "text": "FAUX", "isCorrect": false }
        ]
      },
      {
        "id": 2,
        "title": "Question 7",
        "description": "Les vaisseaux sanguins transportent les nutriments dans le corps, tout comme les rivières et les courants océaniques distribuent les nutriments dans les écosystèmes marins?",
        "options": [
          { "text": "FAUX", "isCorrect": false },
          { "text": "VRAI", "isCorrect": true }
        ]
      },
      {
        "id": 3,
        "title": "Question 8",
        "description": "Les os fournissent de la structure et du soutien, tout comme les récifs coralliens servent d'habitat et de structure pour la vie marine?",
        "options": [
          { "text": "FAUX", "isCorrect": false },
      ...
      },
      {
        "id": 4,
        "title": "Question 9",
        "description": "Le foie filtre les toxines et maintient l'équilibre chimique, tout comme les zones humides côtières et les mangroves filtrent les polluants et maintiennent la qualité de l'eau?",
        "options": [
          { "text": "VRAI", "isCorrect": true },
      ...
      },
      {
        "id": 5,
        "title": "Question 10",
        "description": "Les reins régulent l'équilibre des fluides dans le corps, tout comme les marées circulent les nutriments et éliminent les débris des zones côtières?",
        "options": [
          { "text": "VRAI", "isCorrect": true },
          { "text": "FAUX", "isCorrect": false }
        ]
